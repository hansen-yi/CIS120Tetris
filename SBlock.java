...
public class SBlock extends Piece {
    ...
    public SBlock(int courtWidth, int courtHeight) {
        super(30, 90, 30, 210, 570, courtWidth, courtHeight, 3);
        coordinates = new Position[4];
        coordinates[0] = new Position(90, 30);
        coordinates[1] = new Position(120, 30);
        coordinates[2] = new Position(120, 0);
        ...
        if (this.isMoving()) {
            ...
            for (int i = 0; i < coordinates.length; i++) {
                Square curr = new Square(
                        coordinates[i].getX(), coordinates[i].getY(), Color.GREEN
                );
                curr.draw(g);
